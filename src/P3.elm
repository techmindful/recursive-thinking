...
p3 model =
    ...
    <|
        ...
        , ElmUI.paragraph
            []
            [ ElmUI.text "Our definition will be complete if we simply add 1! = 1 into it:" ]
        , ElmUI.textColumn
        ...
        , ElmUI.paragraph
            []
            [ ElmUI.text "When asked \"what is the factorial of n\", we can keep answering that \"the factorial of n equals to n times the factorial of (n - 1), until we reach \"what is the factorial of 1\". At that point, we can just answer that \"the factorial of 1 equals to 1\". This enables us to answer all the previous questions, in reverse order. Let's look at the example of 4! again:" ]
        , ElmUI.textColumn
