    ...
    let
        preQuiz1 =
            ...
            ElmUI.textColumn
                ...
                , aParaEnd "Therefore, \"the quickest path starting from E\" is EF + FH + HK. It takes 30 minutes."
                ...
                , aParaEnd "Therefore, \"the quickest path starting from H\" is FH + HK. It takes 10 minutes."
                ...
                , aParaEnd "Therefore, \"the quickest path starting from C\" is CE + EF + FH + HK. It takes 35 minutes"
                , plainPara "A: Since \"the quickest path starting from D\" is whichever of the following two paths takes less time:"
                , ElmUI.textColumn
                    vsOneTwoStyle
                ...
                , aParaEnd "Therefore, \"the quickest path starting from D\" is CD + CE + EF + FH + HK. It takes 65 minutes."
                ...
                , aParaEnd "And this path is equivalent to starting from B, taking AB (which takes 0 minute) out, and going through BD + CD + CE + EF + FH + HK."
